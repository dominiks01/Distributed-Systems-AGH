...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void print(int[] list)
    {
        print(list, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void print(int[] list, java.util.Map<String, String> context)
    {
        _iceI_printAsync(list, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printAsync(int[] list)
    {
        return _iceI_printAsync(list, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printAsync(int[] list, java.util.Map<String, String> context)
    {
        return _iceI_printAsync(list, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printAsync(int[] iceP_list, java.util.Map<String, String> context, boolean sync)
    {
