...
public interface Calc extends com.zeroc.Ice.Object
{
    ...
    void print(int[] list, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_print(Calc obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        int[] iceP_list;
        iceP_list = istr.readIntSeq();
        inS.endReadParams();
        obj.print(iceP_list, current);
